...
from vit import backbone as vits
...
if __name__ == "__main__":
    ...
    parser.add_argument('--filter', default=1, type=int,
                        help='0 for the standard finetuning, 1 for the filter.')
    ...
    pretrain_path = '/media/cs4007/adfc2692-0951-4a9b-8ea6-ebfa0e11323b/lcm/Pretraining/dinov2_vitb14_pretrain.pth'

    if args.filter==0:
        backbone = vits.__dict__['dinov2_vitb14']()
    else:
        backbone = vits.__dict__['dinov2_vitb14_filter']()
