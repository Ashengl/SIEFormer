...
if __name__ == "__main__":
    # remeber : False True True grad from 13 and filter from 10
    ...
    parser.add_argument('--dataset_name', type=str, default='herbarium_19',
    ...
    parser.add_argument('--exp_name', default='scars', type=str)
    ...
    # pretrain_path = '/media/cs4007/adfc2692-0951-4a9b-8ea6-ebfa0e11323b/lcm/Pretraining/checkpoint_teacher.pth'
    #
    # if args.filter==0:
    ...
    pretrain_path = '/media/cs4007/adfc2692-0951-4a9b-8ea6-ebfa0e11323b/lcm/Pretraining/dino_vitbase16_pretrain.pth'
    ...
    # device_list = [int(x) for x in '0,1'.split(',')]
